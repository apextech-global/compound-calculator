      ...
      <section className="relative mx-auto max-w-7xl px-6 py-8 sm:py-10 lg:px-8">
        ...
        <div className="mb-6 max-w-4xl">
          <p className="mb-2 text-sm font-semibold uppercase tracking-[0.3em] text-cyan-300">
            Premium Finance Calculators
          </p>
          <h1 className="text-4xl font-bold tracking-tight md:text-6xl">
            Backtest, Project, and Compare Your Investment Plan
          </h1>
          <p className="mt-4 max-w-2xl text-lg leading-8 text-slate-300">
            Start with a historical DCA backtest, or switch to a forward-looking
            compound interest projection when you want to model future growth.
          </p>
        </div>
        ...
        <div className="mb-6 grid gap-4 lg:grid-cols-2">
          ...
          >
            ...
            <p className="max-w-xl text-sm leading-6 text-slate-300">
              Test monthly investments against sample yearly prices for ETFs
          ...
          >
            ...
            <p className="max-w-xl text-sm leading-6 text-slate-300">
              Estimate future portfolio growth with recurring contributions
            ...
            <div className="mb-8 grid gap-8 lg:grid-cols-[1fr_360px] lg:items-end">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-300">
                  Compare how a steady monthly contribution could have
                  performed across sample yearly prices for popular ETFs and
                  stocks.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-cyan-300/20 bg-cyan-400/10 p-6 shadow-2xl shadow-cyan-950/30">
                ...
                <p className="mt-4 text-sm leading-6 text-slate-300">
                  {formatPercent(backtest.totalReturn)}% total return using
                  mock yearly prices for {backtestSymbol}.
                </p>
              </div>
            </div>
          ...
          <section>
            <div className="mb-8 grid gap-8 lg:grid-cols-[1fr_360px] lg:items-end">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-300">
                  Model long-term portfolio growth with recurring
                  contributions, compound returns, and a clear year-by-year

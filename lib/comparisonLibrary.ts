...
type Asset = {
  ...
  index: string;
  expenseRatio: string;
  dividend: "quarterly" | "accumulating";
  holdings: string;
  history: boolean;
};
...
export function getComparisonLibraryEntry(locale: Locale, slug: ComparisonLibrarySlug): ComparisonLibraryEntry {
  ...
  const dividendA = d.a.dividend === "quarterly" ? t.quarterly : t.accumulating;
  const dividendB = d.b.dividend === "quarterly" ? t.quarterly : t.accumulating;
